...
def upgrade():
    op.create_table("campaigns",
        ...
        sa.Column("source", sa.String, index=True, nullable=False),
        ...
        sa.Column("cap_provenance", sa.String, server_default="absent", nullable=False),
        ...
        sa.Column("ingest_method", sa.String, server_default="auto", nullable=False),
        sa.Column("access_status", sa.String, server_default="ingestable", nullable=False),
    ...
    op.create_table("campaign_snapshots",
        ...
        sa.Column("campaign_id", sa.String, index=True, nullable=False),
        ...
        sa.Column("captured_at", sa.String, index=True, nullable=False),
    )
    op.create_table("fetch_events",
        ...
        sa.Column("detected_at", sa.String, index=True, nullable=False),
    )
    op.create_table("platform_trust",
        sa.Column("source", sa.String, primary_key=True),
        sa.Column("trust_score", sa.Float, nullable=False),
        sa.Column("default_fee_pct", sa.Float, nullable=False),
        sa.Column("notes", sa.String, nullable=True),
    )
    op.create_table("niche_baselines",
        sa.Column("niche", sa.String, primary_key=True),
        sa.Column("e_views_median", sa.Integer, nullable=False),
        sa.Column("p_threshold", sa.Float, nullable=False),
    )
    op.create_table("campaign_scores",
        sa.Column("id", sa.Integer, primary_key=True, autoincrement=True),
        sa.Column("campaign_id", sa.String, index=True, nullable=False),
        sa.Column("scored_at", sa.String, nullable=False),
